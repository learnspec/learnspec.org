...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Charter', link: '/charter/' },
      {
        ...
        items: [
          ...
          { text: 'ListenMD: audio scripts', link: '/listenmd/' },
          { text: 'DiagramMD: diagrams', link: '/diagrammd/' },
          { text: 'AnimMD: step-reveal animations', link: '/animmd/' },
          { text: 'MediaMD: media catalogue', link: '/mediamd/' },
          { text: 'GlossaryMD: glossary', link: '/glossarymd/' },
          { text: 'CurriculumMD: reference frameworks', link: '/curriculummd/' },
      ...
      // deploy time, not a VitePress route, so it needs a real navigation.
    ...
    sidebar: {
      '/suite/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ListenMD', link: '/listenmd/' },
            { text: 'DiagramMD', link: '/diagrammd/' },
            { text: 'AnimMD', link: '/animmd/' },
            { text: 'MediaMD', link: '/mediamd/' },
            { text: 'GlossaryMD', link: '/glossarymd/' },
            { text: 'CurriculumMD', link: '/curriculummd/' },
      ...
      '/listenmd/': formatSidebar('ListenMD', 'listenmd'),
      '/diagrammd/': formatSidebar('DiagramMD', 'diagrammd'),
      '/animmd/': formatSidebar('AnimMD', 'animmd'),
      '/mediamd/': formatSidebar('MediaMD', 'mediamd'),
      '/glossarymd/': formatSidebar('GlossaryMD', 'glossarymd'),
      '/curriculummd/': formatSidebar('CurriculumMD', 'curriculummd'),
